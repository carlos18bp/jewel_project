<template>
  ...
  <div class=" xl:mx-auto w-full px-4 lg:max-w-7xl lg:px-8">
        <h2 class="text-center text-6xl font-mayan text-blue">Popular</h2>
        <p class="text-center text-3xl font-italic mt-4">Indulge in what we offer.</p>
      <div class="mt-6 p-8 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
